...
# 面向初学者的机器学习教程：神经网络简介
**简单解释神经网络如何工作，以及从零开始使用Python完成实现。**

可能会让你大吃一惊的是:神经网络并没有你想象的那么复杂!“神经网络”这个词经常被用作流行语，但实际上它比人们往往想象的要简单得多。

这篇文章是为完全初学者准备的，即使零基础的小白也是适用的。我们将了解神经网络如何工作，并从零开始使用Python完成实现。
...
![neurons.png](https://github.com/loopyme/loopyme.github.io/blob/master/_posts/pic/2019-05-01/1.png)
...
1. 激活函数f(x)是什么？
   ...
   激活函数的作用是将无限制的输入转换为可预测形式的输出。它是一类函数的总称，其中一种很常用的激活函数是sigmoid函数，它能将变量映射到0,1之间，表达式为
    $$f(x) = \frac{1}{1+e^{-x}}$$
    在坐标轴上表现是这样的 ![sigmoid.png](https://github.com/loopyme/loopyme.github.io/blob/master/_posts/pic/2019-05-01/2.png)
...
![network.png](https://github.com/loopyme/loopyme.github.io/blob/master/_posts/pic/2019-05-01/3.png)
...
![networkLabled.png](https://github.com/loopyme/loopyme.github.io/blob/master/_posts/pic/2019-05-01/4.png)
