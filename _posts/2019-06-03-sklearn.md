...
首先，为了证明这个Sklearn中文文档是流行的，请使用你的搜索引擎搜索“Sklearn 文档”，看看你是不是也找到的是[这个](http://sklearn.apachecn.org/)页面。这个页面实际上源码托管在Github的apachecn/scikit-learn-doc-zh仓库里，它急需维护与更新。

这将是一个可以写进简历的机器学习入门级项目经历，使得你可以在全面学习Sklearn的同时为开源做出贡献。（还能装逼）
...
## 贡献方式
**在GIthub上：Fork那个仓库(apachecn/scikit-learn-doc-zh)，选解决方式中会的，去改，改好以后发Pull-request。**
